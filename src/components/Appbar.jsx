...
export default function Appbar () {
  ...
  const linkStyle = { textDecoration: 'none', color: darkMode ? '#000' : '#fff' }
  ...
  const renderMobileMenu = (
    ...
    >
      ...
      <MenuItem style={{backgroundColor:darkMode ? '#0f3460' : '#fff'}}>
        <Link aria-label='Go to Shop Page' className='navbar-link' to='/commands'>
          <IconButton
            size='large'
            aria-label='show 17 new notifications'
            color='inherit'
      ...
      <IconButton
        ...
        >
          <Badge badgeContent={17} color='error'>
            <ShoppingCartIcon style={{color:darkMode ? "#fff" : '#0f3460'}} />
          </Badge>
        </IconButton>
          <span
            style={{color:darkMode ? "#fff" : '#0f3460'}}
      ...
      <AppBar style={{backgroundColor:darkMode ? "#0f3460" : '#fff' }} position='fixed'>
        <Toolbar>
          <Typography
            ...
            noWrap
            component='div'
            sx={{ display: { xs: 'none', sm: 'block' },color: darkMode ? "#fff" : '#0f3460' }}
          >
            Wa-commerce
          </Typography>
